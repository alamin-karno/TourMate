...
import com.teamblank.tourmate.Map.GetNearbyPlacesData;
...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_hotel:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapActivity.this, "Showing Nearby Hotels", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.B_pharmacies:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapActivity.this, "Showing Nearby Pharmacies", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyC-O7hSCc9EHPo4bQY3Xg1VEv0yknMrhes");
